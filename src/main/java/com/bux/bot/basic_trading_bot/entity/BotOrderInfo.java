...
public class BotOrderInfo {
  ...
  @Column private String positionId;
  ...
  @Column private int leverage = 2;
  @Column private int decimals = 2;


  @Column private String currency = "BUX";
  @Transient private boolean isProcessing = false;
